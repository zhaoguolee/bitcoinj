...
import org.bchj.core.listeners.BlocksDownloadedEventListener;
import org.bchj.core.listeners.DownloadProgressTracker;
import org.bchj.crypto.*;
import org.bchj.params.MainNetParams;
import org.bchj.params.RegTestParams;
import org.bchj.params.TestNet3Params;
import org.bchj.protocols.payments.PaymentProtocol;
import org.bchj.protocols.payments.PaymentProtocolException;
import org.bchj.protocols.payments.PaymentSession;
import org.bchj.script.Script;
import org.bchj.script.Script.ScriptType;
import org.bchj.script.ScriptException;
import org.bchj.store.*;
import org.bchj.uri.BitcoinURI;
import org.bchj.uri.BitcoinURIParseException;
import org.bchj.utils.BriefLogFormatter;
import org.bchj.wallet.*;
import org.bchj.wallet.Wallet.BalanceType;
import org.bchj.wallet.listeners.WalletChangeEventListener;
...
import org.bchj.wallet.listeners.WalletReorganizeEventListener;
...
import static org.bchj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.bch.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("bitcoin")) {
            ...
            try {
                paymentRequest = org.bch.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch (IOException e) {
