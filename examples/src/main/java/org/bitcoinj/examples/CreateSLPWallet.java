...
public class CreateSLPWallet {
    public static void main(String[] args) throws UnreadableWalletException, InterruptedException, IOException, BlockStoreException {
        ...
        SlpAppKit slpAppKitSeed = new SlpAppKit().initialize(params, new File("."), "wallet_test", new DeterministicSeed("witch collapse practice feed shame open despair creek road again ice least", null, "", walletBirthday));
