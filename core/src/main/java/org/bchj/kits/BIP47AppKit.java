...
import org.bchj.core.bip47.BIP47Address;
import org.bchj.core.bip47.BIP47Channel;
...
import org.bchj.utils.BIP47Util;
import org.bchj.wallet.KeyChainGroupStructure;
import org.bchj.wallet.RedeemData;
import org.bchj.wallet.SendRequest;
import org.bchj.wallet.Wallet;
import org.bchj.wallet.bip47.listeners.BlockchainDownloadProgressTracker;
import org.bchj.wallet.bip47.listeners.TransactionEventListener;
...
import static org.bchj.utils.BIP47Util.getReceiveAddress;
import static org.bchj.utils.BIP47Util.getSendAddress;
...
public class BIP47AppKit extends WalletKitCore {
    ...
    public SendRequest makeNotificationTransaction(String paymentCode, boolean allowUnconfirmedSpends) throws InsufficientMoneyException {
        ...
        org.bchj.utils.BIP47Util.FeeCalculation feeCalculation = BIP47Util.calculateFee(vWallet, sendRequest, ntValue, vWallet.calculateAllSpendCandidates());
