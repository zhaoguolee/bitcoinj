...
import org.bchj.wallet.listeners.CurrentAddressChangeEventListener;
import org.bchj.wallet.listeners.CurrentKeyChangeEventListener;
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @see org.bchj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.bchj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.bchj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
