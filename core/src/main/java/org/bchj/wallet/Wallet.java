...
import org.bchj.core.TransactionConfidence.ConfidenceType;
import org.bchj.core.listeners.NewBestBlockListener;
import org.bchj.core.listeners.ReorganizeListener;
import org.bchj.core.listeners.TransactionConfidenceEventListener;
import org.bchj.core.listeners.TransactionReceivedInBlockListener;
import org.bchj.crypto.*;
import org.bchj.script.*;
import org.bchj.script.Script.ScriptType;
import org.bchj.signers.LocalSchnorrTransactionSigner;
import org.bchj.signers.MissingSigResolutionSigner;
import org.bchj.signers.TransactionSigner;
import org.bchj.utils.BaseTaggableObject;
import org.bchj.utils.ListenerRegistration;
import org.bchj.utils.Threading;
import org.bchj.wallet.Protos.Wallet.EncryptionType;
import org.bchj.wallet.WalletTransaction.Pool;
import org.bchj.wallet.listeners.*;
import org.bchj.wallet.selector.CoinSelector;
import org.bchj.wallet.selector.DefaultCoinSelector;
import org.bchj.wallet.selector.FilteringCoinSelector;
import org.bchj.wallet.selector.KeyTimeCoinSelector;
...
public class Wallet extends BaseTaggableObject
    ...
    /**
     * An alias for calling {@link #freshAddress(org.bchj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bchj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     *
     * @throws org.bchj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.bchj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.bchj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
