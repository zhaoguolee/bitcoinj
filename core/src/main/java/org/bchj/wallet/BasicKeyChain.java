...
import org.bchj.core.BloomFilter;
import org.bchj.core.ECKey;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     *
     * @throws org.bchj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.bchj.wallet.UnreadableWalletException             if the data structures are corrupted/inconsistent
     */
