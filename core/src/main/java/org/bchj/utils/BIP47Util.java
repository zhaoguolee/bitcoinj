...
import org.bchj.core.bip47.BIP47PaymentAddress;
import org.bchj.core.bip47.BIP47PaymentCode;
import org.bchj.crypto.BIP47SecretPoint;
import org.bchj.kits.BIP47AppKit;
...
import org.bchj.wallet.bip47.NotSecp256k1Exception;
...
public class BIP47Util {
    ...
    public static FeeCalculation calculateFee(org.bchj.wallet.Wallet vWallet, SendRequest req, Coin value, List<TransactionOutput> candidates) throws InsufficientMoneyException {
     ...
     */
    static void signTransaction(org.bchj.wallet.Wallet vWallet, SendRequest req, byte[] pubKey, BIP47PaymentCode myBIP47PaymentCode) {
    ...
    private static int estimateBytesForSigning(org.bchj.wallet.Wallet vWallet, CoinSelection selection) {
        int size = 0;
        for (TransactionOutput output : selection.gathered) {
            try {
