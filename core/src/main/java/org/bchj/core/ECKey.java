...
import org.bch.NativeSecp256k1;
import org.bch.NativeSecp256k1Util;
import org.bch.Secp256k1Context;
import org.bchj.crypto.*;
import org.bchj.script.Script;
import org.bchj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     *
     * @throws org.bchj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     *
     * @throws org.bchj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
