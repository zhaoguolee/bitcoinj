...
public class PaymentProtocolTest {
    ...
    private static final Address TO_ADDRESS = AddressFactory.create().fromKey(UNITTEST, new ECKey());
    ...
    public void testPaymentMessage() throws Exception {
        ...
        Address refundAddress = AddressFactory.create().fromKey(UNITTEST, new ECKey());
