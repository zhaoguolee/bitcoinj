...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void createFilteredBlock() throws Exception {
        ...
        Transaction tx2 = FakeTxBuilder.createFakeTx(UNITTEST, Coin.FIFTY_COINS, AddressFactory.create().fromKey(UNITTEST, key2));
        Block block = FakeTxBuilder.makeSolvedTestBlock(UNITTEST.getGenesisBlock(), AddressFactory.create().fromBase58(UNITTEST, "msg2t2V2sWNd85LccoddtWysBTR8oPnkzW"), tx1, tx2);
