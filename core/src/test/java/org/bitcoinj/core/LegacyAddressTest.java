...
public class LegacyAddressTest {
    ...
    public void testJavaSerialization() throws Exception {
        LegacyAddress testAddress = AddressFactory.create().fromBase58(TESTNET, "n4eA2nbYqErp7H6jebchxAN59DmNpksexv");
        ...
        LegacyAddress mainAddress = AddressFactory.create().fromBase58(MAINNET, "17kzeh4N8g49GFvdDzSf8PjaPfyoD1MndL");
    ...
    public void decoding() {
        LegacyAddress a = AddressFactory.create().fromBase58(TESTNET, "n4eA2nbYqErp7H6jebchxAN59DmNpksexv");
        assertEquals("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc", Utils.HEX.encode(a.getHash()));

        LegacyAddress b = AddressFactory.create().fromBase58(MAINNET, "17kzeh4N8g49GFvdDzSf8PjaPfyoD1MndL");
    ...
    public void errorPaths() {
        ...
        try {
            AddressFactory.create().fromBase58(TESTNET, "this is not a valid address!");
            fail();
        ...
        try {
            AddressFactory.create().fromBase58(TESTNET, "");
            fail();
        } catch (AddressFormatException.WrongNetwork e) {
            fail();
        } catch (AddressFormatException e) {
        ...
        try {
            AddressFactory.create().fromBase58(TESTNET, "17kzeh4N8g49GFvdDzSf8PjaPfyoD1MndL");
            fail();
        } catch (AddressFormatException.WrongNetwork e) {
            // Success.
        } catch (AddressFormatException e) {
    ...
    public void p2shAddress() {
        ...
        LegacyAddress mainNetP2SHAddress = AddressFactory.create().fromBase58(MainNetParams.get(), "35b9vsyH1KoFT5a5KtrKusaCcPLkiSo1tU");
        ...
        LegacyAddress testNetP2SHAddress = AddressFactory.create().fromBase58(TestNet3Params.get(), "2MuVSxtfivPKJe93EC1Tb9UhJtGhsoWEHCe");
        ...
        LegacyAddress a = AddressFactory.create().fromScriptHash(MAINNET, hex);
        assertEquals("35b9vsyH1KoFT5a5KtrKusaCcPLkiSo1tU", a.toString());
        LegacyAddress b = AddressFactory.create().fromScriptHash(TESTNET, HEX.decode("18a0e827269b5211eb51a4af1b2fa69333efa722"));
        assertEquals("2MuVSxtfivPKJe93EC1Tb9UhJtGhsoWEHCe", b.toString());
        LegacyAddress c = AddressFactory.create().fromScriptHash(MAINNET,
    ...
    public void p2shAddressCreationFromKeys() {
        ...
        LegacyAddress address = AddressFactory.create().fromScriptHash(MAINNET,
    ...
    public void roundtripBase58() {
        ...
        assertEquals(base58, AddressFactory.create().fromBase58(null, base58).toBase58());
    }

    @Test
    public void comparisonCloneEqualTo() throws Exception {
        LegacyAddress a = AddressFactory.create().fromBase58(MAINNET, "1Dorian4RoXcnBv9hnQ4Y2C1an6NJ4UrjX");
    ...
    public void comparisonLessThan() {
        LegacyAddress a = AddressFactory.create().fromBase58(MAINNET, "1Dorian4RoXcnBv9hnQ4Y2C1an6NJ4UrjX");
        LegacyAddress b = AddressFactory.create().fromBase58(MAINNET, "1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P");
    ...
    public void comparisonGreaterThan() {
        LegacyAddress a = AddressFactory.create().fromBase58(MAINNET, "1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P");
        LegacyAddress b = AddressFactory.create().fromBase58(MAINNET, "1Dorian4RoXcnBv9hnQ4Y2C1an6NJ4UrjX");
    ...
    public void comparisonBytesVsString() throws Exception {
        ...
        while ((line = dataSetReader.readLine()) != null) {
            ...
            LegacyAddress first = AddressFactory.create().fromBase58(MAINNET, addr[0]);
            LegacyAddress second = AddressFactory.create().fromBase58(MAINNET, addr[1]);
