...
public class ECKeyTest {
    ...
    public void base58Encoding() throws Exception {
        ...
        assertEquals(addr, AddressFactory.create().fromKey(TESTNET, key).toString());
    }
    ...
    public void signTextMessage() throws Exception {
        ...
        log.info("Message signed with " + AddressFactory.create().fromKey(MAINNET, key) + ": " + signatureBase64);
    ...
    public void verifyMessage() throws Exception {
        ...
        Address expectedAddress = AddressFactory.create().fromBase58(MAINNET, "14YPSNPi6NSXnUxtPAsyJSuw3pv7AU3Cag");
        ECKey key = ECKey.signedMessageToKey(message, sigBase64);
        Address gotAddress = AddressFactory.create().fromKey(MAINNET, key);
